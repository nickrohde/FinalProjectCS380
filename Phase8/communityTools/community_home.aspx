<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="community_home.aspx.cs" Inherits="Phase8.communityTools.community" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Menu ID="navMenu" runat="server" BackColor="#7407c6" BorderColor="#5d03a0" StaticMenuItemStyle-ForeColor="#FFFFFF" 
        ...
        <Items>
            ...
            <asp:MenuItem Text="Institution Info" NavigateUrl="#"></asp:MenuItem>
