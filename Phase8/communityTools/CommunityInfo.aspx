<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CommunityInfo.aspx.cs" Inherits="Phase8.communityTools.CommunityInfo" %>
    ...
    <div id="MenuBox">
            <asp:Menu ID="navMenu" runat="server" BackColor="#7407c6" BorderColor="#5d03a0" StaticMenuItemStyle-ForeColor="#FFFFFF" 
                ...
                <Items>
                    ...
                    <asp:MenuItem Text="Institution Info" Selected="true"></asp:MenuItem>
